        ...
        return (
            <div className="background-one-time row p-4 d-flex justify-content-center">
                ...
                <div className="container-3 shadow-lg w-50 mt-4 p-4 rounded">
                    <div >
                        <h3><center>Our Valuable Delivary Partner</center></h3>
                        <div className=""><br/>
                            <form onSubmit={this.onSubmit}>
                                <div className="body">
                                    <div className="row">
                                        <div className="row">
                                            <dt className="col-sm-6">Delivary Partner ID</dt>
                                            ...
                                            <dt className="col-sm-6">Delivary Partner Name</dt>
                                            <dd className="col-sm-6">
                                                        <span className="text-info">
                                                            <input
                                                                type="text"
                                            ...
                                            <dt className="col-sm-6">Delivary Location</dt>
                                            <dd className="col-sm-6">
                                                        <span className="text-info">
                                                            <input
                                                                type="text"
