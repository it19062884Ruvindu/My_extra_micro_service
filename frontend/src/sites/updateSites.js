    ...
    onSubmit(e) {
        ...
        axios.put('http://localhost:8081/site/update/' + this.props.match.params.id, siteObject)
            .then((res) => {
                ...
                console.log('Delivary Partner Details successfully updated')
            }).catch((error) => {
            console.log(error)
        })
        ...
        return (
            <div className="background row p-4 d-flex justify-content-center">
                <div className="container-3 w-50 mt-4 shadow pb-4 pt-4 mb-5 rounded">
                    <div >
                        <center><h3>Change Delivary Partner Details</h3></center>
                        <div className="p-3">
                            <form className="row g-3" onSubmit={this.onSubmit}>
                                <div className="col-12">
                                    <label htmlFor="siteID" className="form-label">Delivary Partner ID</label>
                                ...
                                <div className="col-12">
                                    <label htmlFor="name" className="form-label">Delivary Partner Name</label>
                                    <div className="input-group mb-3">
                                ...
                                <div className="col-12">
                                    <label htmlFor="location" className="form-label">Delivary Location</label>
                                    <div className="input-group mb-3">
                                ...
                                <div className="col-md-6">
                                    <button className="mt-4 button-red button2-red">Delete Delivary Partner</button>
                                </div>
                                <div className="col-md-6 d-flex justify-content-md-end">
                                    <button className="mt-4 button-orange button2-orange">Update Delivary Partner</button>
                                </div>
                            </form>
                        </div>
                    </div>
